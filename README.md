...
An end-to-end product analytics project covering experiment design, SQL data engineering, frequentist & Bayesian statistical inference, and uplift modeling.
...
- [ ] Phase 4 — Frequentist statistical testing
- [ ] Phase 5 — Bayesian A/B analysis
- [ ] Phase 6 — Machine learning & uplift modeling
- [ ] Phase 7 — Tableau dashboard
- [ ] Phase 8 — Stakeholder report & GitHub publish

---

*This is a portfolio project. The dataset is from a real Cookie Cats A/B test, available on Kaggle.*